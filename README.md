...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/Pyongu/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/Pyongu/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/Pyongu/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/Pyongu/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/Pyongu/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/Pyongu/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |  7m58.787s                | 1m7.130s                  | 
| `pg_normalized_batch`  |  2m20.985s                | 0m17.003s                 | 
| `pg_denormalized`      |  0m20.249s                | 0m3.932s                  | 
